...
class TestAgentStatus:
    ...
    def test_agent_status_values(self):
        ...
        from orchestration.core.agent import AgentStatus
...
class TestAgentCapability:
    ...
    def test_capability_values(self):
        ...
        from orchestration.core.agent import AgentCapability
...
class TestMessage:
    ...
    def test_message_creation(self):
        ...
        from orchestration.core.agent import Message
...
class SimpleTestAgent:
    ...
    async def execute(self, input_data, context) -> "TaskResult":
        from orchestration.core.agent import TaskResult, AgentStatus
...
class TestAgent:
    ...
    async def test_agent_execution(self, agent):
        ...
        from orchestration.core.agent import AgentContext, TaskResult
...
class TestAgentRegistry:
    ...
    def registry(self):
        ...
        from orchestration.core.agent import AgentRegistry
