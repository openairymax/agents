...
class TestAgentMetrics:
    ...
    def test_agent_metrics_creation(self):
        ...
        from orchestration.strategies.dispatching.dispatching import AgentMetrics
...
class TestTaskContext:
    ...
    def test_task_context_creation(self):
        ...
        from orchestration.strategies.dispatching.dispatching import TaskContext
...
class TestDispatchStrategy:
    ...
    def test_strategy_stats(self):
        ...
        from orchestration.strategies.dispatching.dispatching import WeightedRoundRobinStrategy
...
class TestWeightedRoundRobinStrategy:
    ...
    def test_select_with_weights(self):
        ...
        from orchestration.strategies.dispatching.dispatching import (
...
class TestPriorityBasedStrategy:
    ...
    def strategy(self):
        """Create a test strategy."""
        from orchestration.strategies.dispatching.dispatching import PriorityBasedStrategy
...
class TestLeastLoadedStrategy:
    ...
    def strategy(self):
        """Create a test strategy."""
        from orchestration.strategies.dispatching.dispatching import LeastLoadedStrategy
...
class TestAdaptiveMLStrategy:
    ...
    def strategy(self):
        """Create a test strategy."""
        from orchestration.strategies.dispatching.dispatching import AdaptiveMLStrategy
    ...
    def test_select_adaptive(self, strategy):
        ...
        from orchestration.strategies.dispatching.dispatching import AgentMetrics, TaskContext
